 ...
 * @author Lelê
 * 
 * Infos sobre bytes: double=8, float=4, int=4, caracter=1, long=8, bool=1
 */
public class Endereco 
{
    ...
    final int tamanhoRegistro = 300; //registros + dois readBytes (do próprio arquivo). Facilita e protege a chamada
